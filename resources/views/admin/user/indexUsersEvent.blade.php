                                    ...
                                    <tbody>
                                        @forelse ($users as $user)
                                            <tr>
                                                ...
                                                <td data-head="Fecha Apuntado">{{ date('d-m-Y H:m', $user->pivot->registration_date) }}</td>
                                                ...
                                                <td data-head="Acciones">
                                                    {{-- @if (Auth::User()->id != $user->id)
                                                        ...
                                                        <form action="{{ route('admin.event.destroyParticipante',['idEvent' => $event->idEvento,'idUser'=>$user->id]) }}" method="POST">
                                                            @csrf

                                                            @method('DELETE')
                                                            <button type="submit"
                                                                class="btn btn-danger btn-sm">Eliminar Participante</button>
                                                        </form>
                                                    {{-- @else
